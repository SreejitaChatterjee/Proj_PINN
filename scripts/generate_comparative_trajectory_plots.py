...
def main():
    ...
    for var_name, var_label, var_unit, var_type in VARIABLES:
        ...
        # Create figure with subplots (5x2 grid for 10 trajectories)
    ...
    print(f"\n{'='*80}")
    print(f"SUCCESS: Generated {plot_num-1} comparative plots")
    print(f"  Each plot shows all 10 trajectories as subplots")
