...
def plot_single_trajectory_variable(ax, time, true_vals, pred_vals, var_name, var_label, var_unit,
                                    trajectory_id, mae, rmse, is_predicted):
    ...
    for traj_id in trajectory_ids:
        ...
        for var_name, var_label, var_unit, var_type in VARIABLES:
            ...
            plot_single_trajectory_variable(
                ax, time, true_vals, pred_vals, var_name, var_label, var_unit,
                traj_id, mae, rmse, is_predicted
            )
