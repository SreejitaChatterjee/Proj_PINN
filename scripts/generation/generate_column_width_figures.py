...
def plot_autoregressive_stability(output_dir):
    ...
    ax.annotate(
        ...
        fontweight="bold",
        color=COLORS["modular"],
        bbox=dict(boxstyle="round,pad=0.3", fc="white", ec=COLORS["modular"], lw=1.5),
    )
    ...
    plt.savefig(
        output_dir / "fig_stability_column.pdf",
        format="pdf",
        bbox_inches="tight",
        dpi=600,
    )
    plt.savefig(output_dir / "fig_stability_column.png", dpi=600, bbox_inches="tight")
    plt.close()
...
def plot_ablation_study(output_dir):
    ...
    plt.tight_layout(pad=0.3)
    plt.savefig(
        output_dir / "fig_ablation_column.pdf",
        format="pdf",
        bbox_inches="tight",
        dpi=600,
    )
    plt.savefig(output_dir / "fig_ablation_column.png", dpi=600, bbox_inches="tight")
    plt.close()
...
def plot_failure_modes(output_dir):
    ...
    plt.savefig(
        output_dir / "fig_failure_modes_column.pdf",
        format="pdf",
        bbox_inches="tight",
        dpi=600,
    )
    plt.savefig(output_dir / "fig_failure_modes_column.png", dpi=600, bbox_inches="tight")
    plt.close()
