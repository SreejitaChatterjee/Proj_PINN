...
def train_model_supervised_early_stop(model, train_loader, val_loader, scaler_y,
                                       use_physics, model_name, seed):
    """
...
def least_squares_baseline_fixed(X_train, y_train, X_val, y_val, val_trajectories,
                                  scaler_X, scaler_y):
    """
...
def main():
    ...
    for arch_name, ModelClass in [('Baseline', BaselinePINN), ('Modular', ModularPINN)]:
        ...
        for i, seed in enumerate(SEEDS):
            ...
            if model_path.exists():
                ...
                model, _ = train_model_supervised_early_stop(
                    ...
                    use_physics=True, model_name=arch_name, seed=seed
                )
        ...
        # Compute statistics
        single_mean, single_std, single_ci, single_vals = compute_statistics(seed_results, 'single_step_mae')
        rollout_mean, rollout_std, rollout_ci, rollout_vals = compute_statistics(seed_results, 'rollout_mae')
    ...
    print(f"{'LeastSquares':<15} {'N/A':<10} {r['single_step_mae']:<20.4f} {r['rollout_mae']:<25.3f}")
