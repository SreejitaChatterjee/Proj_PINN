...
\begin{enumerate}
    ...
    \item \textbf{Stability-Oriented Training.} We develop a curriculum-based training protocol (horizon scheduling + scheduled sampling + physics regularization) that enlarges the stability envelope by 51$\times$ while maintaining accurate dynamics prediction (Section~\ref{sec:method}).
\end{enumerate}
