...
A critical gap exists in how PINNs are evaluated versus deployed. Standard benchmarks assess single-step prediction: given ground truth $\mathbf{x}_t$, predict $\hat{\mathbf{x}}_{t+1}$. We demonstrate this metric fundamentally misleads about autoregressive deployment. Models achieving 10$\times$ better single-step accuracy can diverge catastrophically within 100 steps.
