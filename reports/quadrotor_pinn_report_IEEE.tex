...
\begin{figure*}[!t]
\centering
\includegraphics[width=0.95\textwidth]{../results/test_set_trajectories_fixed/01_x_test_trajectories.png}
\caption{X Position vs Time - Test Set (2 Held-Out Trajectories) (Overall MAE: \textbf{1.35 m}, RMSE: \textbf{1.63 m}). Each subplot shows one test trajectory with its true values (blue) and PINN predictions (red dashed). Horizontal position prediction in inertial frame.}
\label{fig:x_position_analysis}
\end{figure*}

\begin{figure*}[!t]
\centering
\includegraphics[width=0.95\textwidth]{../results/test_set_trajectories_fixed/02_y_test_trajectories.png}
\caption{Y Position vs Time - Test Set (2 Held-Out Trajectories) (Overall MAE: \textbf{1.85 m}, RMSE: \textbf{2.25 m}). Each subplot shows one test trajectory with its true values (blue) and PINN predictions (red dashed). Horizontal position prediction in inertial frame.}
\label{fig:y_position_analysis}
\end{figure*}

\begin{figure*}[!t]
\centering
\includegraphics[width=0.95\textwidth]{../results/test_set_trajectories_fixed/03_z_test_trajectories.png}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=0.95\textwidth]{../results/test_set_trajectories_fixed/04_roll_test_trajectories.png}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=0.95\textwidth]{../results/test_set_trajectories_fixed/05_pitch_test_trajectories.png}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=0.95\textwidth]{../results/test_set_trajectories_fixed/06_yaw_test_trajectories.png}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=0.95\textwidth]{../results/test_set_trajectories_fixed/07_p_test_trajectories.png}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=0.95\textwidth]{../results/test_set_trajectories_fixed/08_q_test_trajectories.png}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=0.95\textwidth]{../results/test_set_trajectories_fixed/09_r_test_trajectories.png}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=0.95\textwidth]{../results/test_set_trajectories_fixed/10_vx_test_trajectories.png}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=0.95\textwidth]{../results/test_set_trajectories_fixed/11_vy_test_trajectories.png}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=0.95\textwidth]{../results/test_set_trajectories_fixed/12_vz_test_trajectories.png}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=0.95\textwidth]{../results/test_set_trajectories_fixed/13_thrust_test_trajectories.png}
\caption{Total Thrust vs Time - Test Set (2 Held-Out Trajectories). \textbf{Control input (NOT predicted)} showing realistic motor dynamics with 80ms time constant. Each subplot shows one trajectory's thrust command profile.}
\label{fig:thrust_analysis}
\end{figure*}

\begin{figure*}[!t]
\centering
\includegraphics[width=0.95\textwidth]{../results/test_set_trajectories_fixed/14_torque_x_test_trajectories.png}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=0.95\textwidth]{../results/test_set_trajectories_fixed/15_torque_y_test_trajectories.png}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=0.95\textwidth]{../results/test_set_trajectories_fixed/16_torque_z_test_trajectories.png}
