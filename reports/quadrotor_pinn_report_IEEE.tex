...
\begin{table*}[!t]
\centering
\scriptsize{p{0.24\textwidth} p{0.34\textwidth} p{0.31\textwidth}}
\toprule
...
\begin{table*}[!t]
\centering
\scriptsize{|p{0.14\textwidth}|p{0.14\textwidth}|p{0.14\textwidth}|p{0.14\textwidth}|p{0.22\textwidth}|}
\hline
...
\begin{table*}[!t]
\centering
\scriptsize{|p{0.05\textwidth}|p{0.15\textwidth}|p{0.08\textwidth}|p{0.12\textwidth}|p{0.25\textwidth}|p{0.15\textwidth}|}
\hline
...
\begin{table*}[!t]
\centering
\scriptsize{|p{0.05\textwidth}|p{0.2\textwidth}|p{0.1\textwidth}|p{0.12\textwidth}|p{0.4\textwidth}|}
\hline
...
\begin{table*}[!t]
\centering
\scriptsize{|p{0.05\textwidth}|p{0.15\textwidth}|p{0.1\textwidth}|p{0.12\textwidth}|p{0.25\textwidth}|p{0.15\textwidth}|}
\hline
...
\begin{table*}[!t]
\centering
\scriptsize{|p{0.2\textwidth}|p{0.25\textwidth}|p{0.25\textwidth}|p{0.15\textwidth}|}
\hline
...
\begin{table*}[!t]
\centering
\scriptsize{|p{0.2\textwidth}|p{0.55\textwidth}|p{0.15\textwidth}|}
\hline
...
\begin{table*}[!t]
\centering
\scriptsize{|p{0.18\textwidth}|p{0.38\textwidth}|p{0.28\textwidth}|}
\hline
...
\begin{table*}[!t]
\centering
\scriptsize{|l|c|c|p{0.38\textwidth}|}
\hline
...
\begin{table*}[!t]
\centering
\scriptsize{|p{0.15\textwidth}|p{0.12\textwidth}|p{0.12\textwidth}|p{0.12\textwidth}|p{0.12\textwidth}|p{0.20\textwidth}|}
\hline
...
\begin{table*}[!t]
\centering
\scriptsize{|p{0.25\textwidth}|p{0.20\textwidth}|p{0.45\textwidth}|}
\hline
...
\begin{table*}[!t]
\centering
\scriptsize{|p{0.2\textwidth}|p{0.3\textwidth}|p{0.4\textwidth}|}
\hline
...
\begin{table*}[!t]
\centering
\scriptsize{|p{0.3\textwidth}|p{0.6\textwidth}|}
\hline
...
\begin{table*}[!t]
\centering
\scriptsize{|p{0.08\textwidth}|p{0.25\textwidth}|p{0.12\textwidth}|p{0.43\textwidth}|}
...
\begin{table*}[!t]
\centering
\scriptsize{|p{0.25\textwidth}|p{0.2\textwidth}|p{0.45\textwidth}|}
\hline
...
\textbf{Motivation:} The original physics loss enforces Newton-Euler equations but provides weak gradient signals for inertia parameters (Jxx, Jyy, Jzz) at small angles ($\pm20°$), leading to 5.00\% residual errors.
...
P_{\text{drag}} &= c_d(v_x^2|v_x| + v_y^2|v_y| + v_z^2|v_z|)
\end{align}
...
\textbf{Problem:} Training data uses $\pm20°$ attitudes, resulting in small angular rates ($<1$ rad/s) and weak cross-coupling terms in Euler equations:
\begin{equation}
...
\textbf{Solution:} Generated 5 aggressive trajectories with $\pm45°$ to $\pm60°$ attitudes:
...
\hline
100 & Aggressive multi-axis & $\pm45°$ & 90.2 \\
101 & Very aggressive & $\pm50°$ & 70.8 \\
102 & Extreme fast flips & $\pm60°$ & 7.1 \\
103 & Mixed-rate excitation & $\pm55-60°$ & 47.0 \\
104 & Synchronized all-axis & $\pm50°$ & 27.9 \\
\hline
\end{tabular}
\end{table}
...
\item \textbf{Root cause:} Weak observability at small angles ($\pm20°$)
\item \textbf{Physics:} Cross-coupling terms $(J_{yy} - J_{zz})qr \approx 0$ at low angular rates
\item \textbf{Mitigation:} Aggressive trajectories ($\pm45--60°$) and energy conservation loss implemented
\end{itemize}
...
\hline
Roll/Pitch & $\pm20°$ & $>40°$ unreliable \\
Yaw & $\pm30°$ & $>60°$ unreliable \\
...
\begin{enumerate}
\item \textbf{Large angles ($>40°$):} Kinematics break down, gimbal lock risk
...
\item Standard flight maneuvers ($<30°$ attitudes)
...
\begin{itemize}
\item Acrobatic flight ($>45°$ attitudes, flips)
...
\textbf{Hypothesis:} Aggressive maneuvers with larger angles ($\pm45-60°$) will excite cross-coupling dynamics more strongly, providing better gradient signals for inertia parameter identification.

\textbf{Dataset:}
\begin{itemize}
\item \textbf{Standard trajectories:} 49,365 samples (10 trajectories, $\pm20°$ angles)
\item \textbf{Aggressive trajectories:} 20,873 samples (5 trajectories, $\pm45-60°$ angles)
...
The \texttt{QuadrotorSimulator} uses simplified physics that become inaccurate at $\pm60°$ attitudes:
...
\item \textbf{Blade flapping:} Propeller thrust varies with rotor tilt angle: $T_{\text{eff}} = T_{\text{cmd}} \cos(\theta_{\text{flap}})$. At $\pm60°$, thrust can drop by 50\%

\item \textbf{Aerodynamic stall:} Propeller efficiency drops at high angles of attack

\item \textbf{Small-angle approximations:} Some kinematic terms use linearized forms that break down beyond $\pm30°$
\end{enumerate}
...
\begin{enumerate}
\item Standard data ($\pm20°$) has weak inertia observability
\item Aggressive data ($\pm60°$) excites cross-coupling terms
...
This is the \textbf{state-of-the-art} for simulation-based training at $\pm20°$ operating envelope.
...
\begin{itemize}
\item Fly Crazyflie 2.0 at various angles ($\pm20°, \pm40°, \pm60°$)
...
\begin{itemize}
\item \checkmark Definitively validated $\pm20°$ as operating envelope limit
...
\textbf{Key Takeaway:} The original Optimized PINN v2 with standard $\pm20°$ trajectories remains the best model. The 5.00\% inertia error represents the \textbf{limit of simulation-based identification}. Further improvement requires either better simulation physics or real hardware data.
