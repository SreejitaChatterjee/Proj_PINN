...
\caption{X Position vs Time - Test Set (15 Held-Out Trajectories) (Overall MAE: \textbf{1.43 m}, RMSE: \textbf{1.79 m}). Each subplot shows one test trajectory with its true values (blue) and PINN predictions (red dashed). Horizontal position prediction in inertial frame from diverse training set.}
...
\caption{Y Position vs Time - Test Set (15 Held-Out Trajectories) (Overall MAE: \textbf{1.79 m}, RMSE: \textbf{2.13 m}). Each subplot shows one test trajectory with its true values (blue) and PINN predictions (red dashed). Horizontal position prediction in inertial frame from diverse training set.}
...
\caption{Z Position (Altitude) vs Time - Test Set (15 Held-Out Trajectories) (Overall MAE: \textbf{4.65 m}, RMSE: \textbf{5.47 m}). Each subplot shows one test trajectory with its true values (blue) and PINN predictions (red dashed). Vertical position tracking by PINN from diverse training set.}
...
\caption{Roll Angle ($\phi$) vs Time - Test Set (15 Held-Out Trajectories) (Overall MAE: \textbf{0.0327 rad (1.87°)}, RMSE: \textbf{0.0452 rad}). Each subplot shows one trajectory with its true values (blue) and PINN predictions (red dashed). Roll angle prediction from diverse training set.}
...
\caption{Pitch Angle ($\theta$) vs Time - Test Set (15 Held-Out Trajectories) (Overall MAE: \textbf{0.0267 rad (1.53°)}, RMSE: \textbf{0.0338 rad}). Each subplot shows one trajectory with its true values (blue) and PINN predictions (red dashed). Pitch angle prediction from diverse training set.}
...
\caption{Yaw Angle ($\psi$) vs Time - Test Set (15 Held-Out Trajectories) (Overall MAE: \textbf{0.0353 rad (2.02°)}, RMSE: \textbf{0.0467 rad}). Each subplot shows one trajectory with its true values (blue) and PINN predictions (red dashed). Yaw angle prediction from diverse training set.}
...
\caption{Roll Rate (p) vs Time - Test Set (15 Held-Out Trajectories) (Overall MAE: \textbf{0.0635 rad/s}, RMSE: \textbf{0.0893 rad/s}). Each subplot shows one trajectory with its true values (blue) and PINN predictions (red dashed). Roll rate prediction from diverse training set.}
...
\caption{Pitch Rate (q) vs Time - Test Set (15 Held-Out Trajectories) (Overall MAE: \textbf{0.0639 rad/s}, RMSE: \textbf{0.1075 rad/s}). Each subplot shows one trajectory with its true values (blue) and PINN predictions (red dashed). Pitch rate prediction from diverse training set.}
...
\caption{Yaw Rate (r) vs Time - Test Set (15 Held-Out Trajectories) (Overall MAE: \textbf{0.0929 rad/s}, RMSE: \textbf{0.1489 rad/s}). Each subplot shows one trajectory with its true values (blue) and PINN predictions (red dashed). Yaw rate prediction from diverse training set.}
...
\caption{X Velocity (u, body frame) vs Time - Test Set (15 Held-Out Trajectories) (Overall MAE: \textbf{0.553 m/s}, RMSE: \textbf{0.669 m/s}). Each subplot shows one trajectory with its true values (blue) and PINN predictions (red dashed). Horizontal velocity component from diverse training set.}
...
\caption{Y Velocity (v, body frame) vs Time - Test Set (15 Held-Out Trajectories) (Overall MAE: \textbf{0.660 m/s}, RMSE: \textbf{0.805 m/s}). Each subplot shows one trajectory with its true values (blue) and PINN predictions (red dashed). Horizontal velocity component from diverse training set.}
...
\caption{Z Velocity (w, vertical) vs Time - Test Set (15 Held-Out Trajectories) (Overall MAE: \textbf{1.959 m/s}, RMSE: \textbf{2.340 m/s}). Each subplot shows one trajectory with its true values (blue) and PINN predictions (red dashed). Vertical velocity tracking from diverse training set.}
