...
\item \textbf{Inertia Parameter Errors}: While mass/kt/kq achieve 0\% error, inertias show 30-46\% errors (Jxx: 31.2\%, Jyy: 30.4\%, Jzz: 46.4\%), likely due to limited rotational excitation in training trajectories.
\end{itemize}
