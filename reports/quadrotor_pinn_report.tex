...
\caption{Physical Parameter Identification (IDEALIZED - NOT ACTUAL DATA) - Hypothetical curves. \textbf{Actual results:} Mass/kt/kq < 0.1\% error; Jxx/Jyy/Jzz have 1300-6700\% errors (observability problem). See Figures 13-18 for real training curves and Section 7.5 for analysis.}
