...
The system successfully predicts 12 state variables while identifying 6 critical physical parameters (mass, inertia tensor components, and motor coefficients) with remarkable accuracy. Training data uses SQUARE WAVE reference inputs to test realistic step response behavior.
...
\hline
\textbf{Output} & 128 & 18 & 2,322 & Next state + parameter prediction \\
\hline
\textbf{Physics Params} & - & - & 6 & Learnable physical constants (m, Jxx, Jyy, Jzz, kt, kq) \\
\hline
\textbf{Total} & - & - & \textbf{53,526} & Complete trainable parameters \\
\hline
\end{longtable}
