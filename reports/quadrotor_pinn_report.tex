...
\addlinespace[3pt]
\textbf{2. Trajectory Generation} & Created 10 diverse flight trajectories with SQUARE WAVE reference inputs for realistic step response testing & 10 × 5,000 samples = 50,000 comprehensive data points \\
\addlinespace[3pt]
