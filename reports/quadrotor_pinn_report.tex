...
\begin{figure}[H]
\centering
\includegraphics[width=1.4\textwidth,page=2,trim=0 1.5cm 0 0,clip]{pinn_schematics.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.4\textwidth,page=1]{pinn_schematics.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.4\textwidth,page=4,trim=0 2cm 0 0,clip]{pinn_schematics.pdf}
...
\hline
\textbf{Rotational} & $\dot{p} = t_1 \times q \times r + \tau_x/J_{xx}$ & Cross-coupling (NO artificial damping) \\
\hline
\textbf{Rotational} & $\dot{q} = t_2 \times p \times r + \tau_y/J_{yy}$ & Cross-coupling (NO artificial damping) \\
\hline
\textbf{Rotational} & $\dot{r} = t_3 \times p \times q + \tau_z/J_{zz}$ & Cross-coupling (NO artificial damping) \\
\hline
\textbf{Translational} & $\dot{w} = -T \times \cos(\theta) \times \cos(\phi) / m + g - 0.05 \times v_z \times |v_z|$ & Thrust + gravity + quadratic drag ($c_d=0.05$ kg/m) \\
\hline
\end{longtable}
