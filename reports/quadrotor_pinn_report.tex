...
\caption{Total Thrust vs Time - \textbf{Control input (NOT predicted)} showing realistic motor dynamics with 80ms time constant. Red line matches blue line as this is a measured signal used as model input.}
...
\caption{Roll Torque ($\tau_x$) vs Time - \textbf{Control input (NOT predicted)} for roll attitude maneuvers. Red line matches blue line as this is a measured signal used as model input.}
...
\caption{Pitch Torque ($\tau_y$) vs Time - \textbf{Control input (NOT predicted)} for pitch attitude maneuvers. Red line matches blue line as this is a measured signal used as model input.}
...
\caption{Yaw Torque ($\tau_z$) vs Time - \textbf{Control input (NOT predicted)} for yaw (heading) maneuvers. Red line matches blue line as this is a measured signal used as model input.}
