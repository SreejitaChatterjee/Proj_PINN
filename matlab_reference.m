...
rref=k12*(psir-psi)+ki2*sumpsi*dt;  % r ref - CORRECTED: using sumpsi instead of sumt
...
% altitude hold
zr=-5.0;
kv=-1.0; kz1=2.0; kz2=0.1*1.5;  % CORRECT: Negative gain required for z-down coordinate system
sumz=sumz+(zr-z);
